...
/* harmony import */ var _checkEmptyInput__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./checkEmptyInput */ "./src/js/modules/checkEmptyInput.js");
...
function changeModalState(state) {
  ...
  Object(_checkEmptyInput__WEBPACK_IMPORTED_MODULE_2__["default"])('button[data-lockBtn-for-input]', windowWidth[0], windowHeight[0]);
  chackEmptyChackbox('.popup_calc_profile_button');

  function chackEmptyChackbox(selectorBtn) {
    var chackboxCustom = document.querySelectorAll('.popup_calc_profile_content > label > span.checkbox-custom');
    ...
    chackboxCustom.forEach(function (item) {
    ...
    var openBtn = function openBtn() {
      return document.querySelector(selectorBtn).removeAttribute('disabled', 'disabled');
    };
  }
...
/***/ "./src/js/modules/checkEmptyInput.js":
/*!*******************************************!*\
  !*** ./src/js/modules/checkEmptyInput.js ***!
  \*******************************************/
/*! exports provided: default */
...
var checkEmptyInputs = function checkEmptyInputs(selectorBtn) {
  ...
  var swichFirstInput = false;
  var swichSecondInput = false;
  ...
  function checkInput(btn) {
    ...
    var resSwich = function resSwich() {
...
/* harmony default export */ __webpack_exports__["default"] = (checkEmptyInputs);
...
function checkNumInput(inputSelector) {
  var numInput = document.querySelectorAll(inputSelector);
...
function forms(state) {
  function postData() {
    ...
    var serverPostData = function serverPostData(url, data) {
      var res;
    ...
    var inputReset = function inputReset() {
    ...
    form.forEach(function (item) {
      item.addEventListener('submit', function (e) {
        ...
        serverPostData('/assets/server.php', formData).then(function (data) {
          console.log(data);
...
function tabs() {
  function showTabs(headerSelector, tabsItem, contentSelector, activeItem) {
